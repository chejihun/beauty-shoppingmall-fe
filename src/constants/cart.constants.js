...
export const DELETE_CART_REQUEST = "DELETE_CART_ITEM_REQUEST";
export const DELETE_CART_SUCCESS = "DELETE_CART_ITEM_SUCCESS";
export const DELETE_CART_FAIL = "DELETE_CART_ITEM_FAIL";
